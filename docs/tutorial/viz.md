...
!!!note
	All SedonaViz SQL/DataFrame APIs are explained in [SedonaViz API](../../api/viz/sql). Please see [Viz example project](https://https://github.com/apache/sedona/tree/master/examples/spark-viz).
